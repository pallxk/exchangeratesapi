...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Exchangeratesapi.DailyRates();
  });
  ...
  describe('DailyRates', function() {
    it('should create an instance of DailyRates', function() {
      // uncomment below and update the code to test DailyRates
      //var instane = new Exchangeratesapi.DailyRates();
      //expect(instance).to.be.a(Exchangeratesapi.DailyRates);
    });
